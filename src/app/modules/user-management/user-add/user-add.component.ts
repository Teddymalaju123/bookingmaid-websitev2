...
export class UserAddComponent implements OnInit {
  ...
  floorData: { label: string, value: number, start:number,end:number ,size:string}[] = [
    ...
    { label: '17', value: 17 ,start:141, end:154,size:"34.5 sq m"},
    { label: '18', value: 18 ,start:155, end:168,size:"34.5 sq m"},
    { label: '19', value: 19 ,start:169, end:182,size:"34.5 sq m"},
    { label: '20', value: 20 ,start:183, end:196,size:"34.5 sq m"},
    { label: '21', value: 21 ,start:197, end:210,size:"34.5 sq m"},
    { label: '22', value: 22 ,start:211, end:224,size:"34.5 sq m"},
    { label: '23', value: 23 ,start:225, end:238,size:"34.5 sq m"},
    { label: '24', value: 24 ,start:239, end:252,size:"34.5 sq m"},
    { label: '25', value: 25 ,start:253, end:266,size:"34.5 sq m"},
    { label: '26', value: 26 ,start:267, end:280,size:"34.5 sq m"},
    { label: '27', value: 27 ,start:281, end:294,size:"34.5 sq m"},
    { label: '28', value: 28 ,start:295, end:308,size:"49.5 -50.25 sq m"},
    { label: '29', value: 29 ,start:309, end:322,size:"49.5 -50.25 sq m"},
    { label: '30', value: 30 ,start:323, end:336,size:"49.5 -50.25 sq m"},
    { label: '31', value: 31 ,start:337, end:350,size:"49.5 -50.25 sq m"},
    { label: '32', value: 32 ,start:351, end:364,size:"49.5 -50.25 sq m"},
    { label: '33', value: 33 ,start:365, end:378,size:"49.5 -50.25 sq m"},
    { label: '34', value: 34 ,start:379, end:393,size:"49.5 -50.25 sq m"},
    { label: '35', value: 35 ,start:394, end:407,size:"49.5 -50.25 sq m"},
    { label: '36', value: 36 ,start:408, end:421,size:"49.5 -50.25 sq m"},
  ];
